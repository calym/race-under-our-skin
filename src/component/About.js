      ...
      <div>
        ...
        <div className="about-content">
          ...
          <p className="quote-text">
            <i>Under Our Skin</i> grew out of conversations about how we at <i>The Seattle Times</i> cover race at a time when national and local events — the furor over police shootings, the rise of the Black Lives Matter movement, protests on college campuses and charged campaign rhetoric — dominate headlines.
          </p>
          <p className="quote-text">
          ...
          <p className="quote-text">
            ...
            those who tend to take sides right away when the issue of race comes up, we hope <i>Under Our Skin</i> will challenge assumptions and build common ground.
          </p>
          <p className="quote-text ellipse">...</p>
          <p className="quote-text">With many thanks to our 18 interviewees, and all of you,</p>
          <p className="quote-text">
            The <i>Under Our Skin</i> team at
            <i>The Seattle Times</i>
          </p>
      ...
      {langID === 'spa' && (
        <div>
          ...
          <div className="about-content">
            ...
            <p className="quote-text">
              <i>Under Our Skin (Bajo nuestra piel)</i> surgió de conversaciones acerca de cómo nosotros en <i>The Seattle Times</i> cubrimos temas sobre raza en un momento en que los sucesos nacionales y locales—el furor por los tiroteos policiales, el surgimiento del movimiento Black Lives Matter, las protestas en los campus universitarios y la retórica cargada de la campaña política—dominan los titulares.
            </p>
            <p className="quote-text">
